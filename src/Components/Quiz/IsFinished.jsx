    ...
    <>
      ...
      <Modal show={show}>
        ...
        <Modal.Body>
          ...
          <p className={styles.text}>🏆 Te has ganado una insignia por tu hazaña, puedes chekear tu perfil 🏆</p>
            <button  className={styles.button} onClick={(e) => handleSumbitScore()}>Subir Puntuacion 🚀</button> <button className={styles.button}>Dar feedBack en el foro</button>
        </Modal.Body>
      </Modal>
    </>
  );
